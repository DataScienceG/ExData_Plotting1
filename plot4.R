...
datetime <-strptime(paste(subSetPC_Data$Date, subSetPC_Data$Time, sep=" "), "%d/%m/%Y %H:%M:%S") 
 ...
 plot(datetime,  as.numeric(subSetPC_Data$Global_active_power) , type="l", xlab="", ylab="Global Active Power", cex=0.2) 
 
  plot(datetime, as.numeric(subSetPC_Data$Voltage) , type="l", xlab="datetime", ylab="Voltage") 
 ...
 lines(datetime, as.numeric(subSetPC_Data$Sub_metering_2) , type="l", col="blue") 
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty=, lwd=2.5, col=c("black", "red", "blue"), bty="o")  
 
plot(datetime,  as.numeric(subSetPC_Data$Global_reactive_power), type="l", xlab="datetime", ylab="Global_reactive_power") 
